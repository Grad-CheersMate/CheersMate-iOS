...
// MARK: - VC: 뷰 컨트롤러, NC: 네비게이션 뷰 컨트롤러, VM: 뷰 모델, UC: 유스케이스, RP: 리포지토리, Net: 네트워크
...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func changeRootViewController() {
        ...
        let tabBarController = MainTabBarController() // 탭 바
        window.rootViewController = tabBarController // 루트 뷰 교체
