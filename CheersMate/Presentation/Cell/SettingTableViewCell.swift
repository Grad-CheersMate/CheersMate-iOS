...
//  CheersMate
//
//  Created by 재훈 on 11/27/24.
//

import UIKit

// MARK: - 세팅 셀 (메인 이미지 + 설명 레이블 + 서브 이미지)
public final class SettingTableViewCell: UITableViewCell {
    ...
    private func setupLayout() {
        ...
        subImageView.snp.makeConstraints { make in
            make.leading.greaterThanOrEqualTo(descLabel.snp.trailing).offset(10)
            make.trailing.top.bottom.centerY.equalToSuperview()
        }
    }
